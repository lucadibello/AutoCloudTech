        ...
        <section class="my-5">
            <div class="row">
                <div class="col-md-4 text-center mb-5">
                    <a href="#website-section" data-scroll>
                ...
                <div class="col-md-4 text-center mb-5">
                    <a href="#reglookup-section" data-scroll>
                ...
                <div class="col-md-4 text-center mb-5">
                    <a href="#accounting-section" data-scroll>
            ...
            <div class="row">
                <div class="col-md-4 text-center mb-5">
                    <a href="#tecdoc-section" data-scroll>
                ...
                <div class="col-md-4 text-center mb-5">
                    <a href="#stockcontrol-section" data-scroll>
                ...
                <div class="col-md-4 text-center mb-5">
                    <a href="#partnumber-section" data-scroll>
            ...
            <div class="row">
                ...
                <div class="col-md-7 text-center">
                    <div class="row">
                        ...
                        <div class="col-md-4 m-2">
                            <p class="font-weight-bold">FIFO / LIFO / Extra</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 m-2">
                            <p class="font-weight-bold">Margin Settings</p>
                        </div>
                        <div class="col-md-4 m-2">
                            <p class="font-weight-bold">Integrated Re Order Levels</p>
                        </div>
                    </div>
                </div>
            </div>
